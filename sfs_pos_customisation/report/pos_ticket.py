...
class pos_ticket_report(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(pos_ticket_report, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.pos.ticket.report', 'pos.order', 'addons/sfs_pos_customisation/report/pos_ticket_report.rml',
                      parser=pos_ticket_report, header=False)
