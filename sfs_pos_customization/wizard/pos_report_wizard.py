...
class pos_report_wizard(osv.osv_memory):
    ...
    def print_report(self, cr, uid, ids, context=None):
        ...
        data['form'] = self.read(cr, uid, ids, ['from_date', 'to_date', 'user_ids'], context=context)[0]
        if not data['form']['user_ids']:
            data['form']['user_ids'] = user_pool.search(cr, uid, [], context=context)
